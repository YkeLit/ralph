...
- One of the following AI coding tools installed and authenticated:
  ...
  - Codex CLI (`codex` command with `codex exec` support)
...
# OR
cp /path/to/ralph/AGENTS.md scripts/ralph/AGENTS.md    # For Codex CLI
...
| `AGENTS.md` | Prompt template for Codex CLI |
...
After copying `prompt.md` (for Amp), `CLAUDE.md` (for Claude Code), or `AGENTS.md` (for Codex CLI) to your project, customize it for your project:
